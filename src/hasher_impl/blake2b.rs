...
/// Blake2b hasher.
pub struct Blake2bHasher<Size: ArrayLength<u8>> {
    _marker: PhantomData<Size>,
    state: State,
}

impl<Size: ArrayLength<u8>> Default for Blake2bHasher<Size> {
    fn default() -> Self {
...
impl<Size: ArrayLength<u8>> Hasher for Blake2bHasher<Size> {
    type Size = Size;
